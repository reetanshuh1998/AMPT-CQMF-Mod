...
ROOT_GAU = '/home/reet/medium_modification/Ampt-v1.26t9-v2.26t9/grid_size_10x3/kekcc_submission/ampt_localdensity.root'
...
res_lin = process_root_in_chunks(ROOT_LIN, "Linear/Block")
...
for ax, (_, label, star_file, star_label) in zip(axs, species):
    ...
    ax.errorbar(pt_centers, v2m_lin, yerr=v2e_lin,
                ...
                label=r'Local Density (Block Avg.)', zorder=8)
    ...
    ax.errorbar(pt_centers, v2m_gau, yerr=v2e_gau,
                ...
                markersize=6, capsize=2, elinewidth=0.8,
                label=r'Local Density (Gaussian Kernel)', zorder=9)
    ...
    # Custom limit for pions if needed, but auto works well.
    if label == "Pions":
...
fig.suptitle(
    r'Smoothing Kernel Effect on $v_2(p_T)$ — $10\times10\times10$ grid vs STAR BES-I @ 7.7 GeV',
    fontsize=15, fontweight='bold', y=1.01
)
fig.tight_layout()
outpath = f'{OUTDIR}/smoothing_kernel_v2_comparison.png'
